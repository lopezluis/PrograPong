...
#include "reaccion_maquina.h" // por maquina_con_limite_reaccion, limitar_reaccion_maquina
...
void mostrar_barra_maquina(Juego *juego)
{
	...
	// Borrar el excedente superior de la barra de la máquina, si corresponde
	...
	// Borrar el excedente inferior de la barra de la maquina, si corresponde
