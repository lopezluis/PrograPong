...
{
    // Tener en cuenta que para Linux no hace falta establecer el código de página, el siguiente seteo es para windows
    system("chcp 850 > NUL");
	// Inicializar ncurses/pdcurses, el comportamiento de la librería tanto en Linux como en Windows es muy bueno,
